...
extension PersonViewController {
    ...
    private func setupNavigationBar() {
        navigationItem.title = "Список владельцев"
    ...
    private func updatePerson(_ person: Person, at indexPath: IndexPath ) {
        showAlert(with: "Изменить", currentText: person.name) { name in
            person.name = name
    ...
    private func showAlert(with title: String, currentText: String? = nil, action: @escaping (String) -> Void) {
